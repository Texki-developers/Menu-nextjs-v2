    ...
    return (
        <div>
            <div className="flex flex-col gap-4 p-4 min-h-dvh bg-background">
                <h1 className="text-2xl font-bold">{t("exclusiveOffers")}</h1>
                <div className="bg-linear-to-r from-primary to-secondary rounded-xl p-4 text-white flex items-center justify-between shadow-lg">
                    <div>
                        <p className="text-xs font-medium opacity-90 mb-1">{t("flashSaleEndsIn")}</p>
                ...
                <h2 className="text-lg font-bold text-gray-800">{t("todaysTopPicks")}</h2>
