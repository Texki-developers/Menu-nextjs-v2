...
export const heroBannerConfig: HeroBannerConfig[] = [
  ...
  },
  {
    ...
    description: "Start your day right with our hearty breakfast platter at a special price.",
  },
  {
    id: "3",
    image:
    ...
    description: "Your favorite burgers, fries, and drinks combo. Quick, tasty, and satisfying.",
  },
];
